...
function evaluateQuestion1(){
    ...
    return array("points"=>$points, "feedback"=>$feedback1);
}
...
function evaluateQuestion2(){
    ...
    return array("points"=>$points, "feedback"=>$feedback);
}
...
function evaluateQuestion3(){
    ...
    return array("points"=>$points3, "feedback"=>$feedback3);
}
...
function evaluateQuestion4(){
    ...
    return array("points"=>$points4, "feedback"=>$feedback4);
}
...
Um an der Einerstelle Minus zu rechnen, benötigst du einen Übertrag in die Zehnerstelle.";
    ...
    return array("points"=>$points5, "feedback"=>$feedback5);
}
...
function evaluateQuestion6(){
    ...
    return array("points"=>$points6, "feedback"=>$feedback6);
}
...
function evaluateQuestion7(){
    ...
    return array("points"=>$points7, "feedback"=>$feedback7);
}
