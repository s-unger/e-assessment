        ...
        <div class="charts">
            ...
            <div class="pie_chart svg-container">
                ...
                <div id="misconceptionAll"
                    ...
                    <?php if ($_SESSION['misconceptionAll'] === 0) echo "<p>Du machst häufig diesen Fehler: </p> $misconceptionReminder5_0";
                    elseif ($_SESSION['misconceptionAll'] === 1) echo "<p>Du machst häufig diesen Fehler: </p> $misconceptionReminder5_1";
                    elseif ($_SESSION['misconceptionAll'] === 2) echo "<p>Du machst häufig diesen Fehler: </p> $misconceptionReminder5_2";
                    ?></div>
                <div id="misconception5"
                     style="display: none; margin: 5% 5% 0 5%;">
                    <?php if ($_SESSION['misconception5'] === 0) echo "<p>Du machst häufig diesen Fehler: </p> $misconceptionReminder5_0";
                    elseif ($_SESSION['misconception5'] === 1) echo "<p>Du machst häufig diesen Fehler: </p> $misconceptionReminder5_1";
                    elseif ($_SESSION['misconception5'] === 2) echo "<p>Du machst häufig diesen Fehler: </p> $misconceptionReminder5_2";
                    ?></div>
